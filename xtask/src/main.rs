...
fn web_exports() -> Vec<(String, String)> {
...
fn theme_module() -> String {
    ...
    out.push_str(&format!(
        ...
        ids.join(", "),
        zest_theme::builtin::DEFAULT_DARK,
        zest_theme::builtin::DEFAULT_LIGHT,
    ));
    out
}
...
fn export_web(check_only: bool) -> ExitCode {
    ...
    for (path, generated) in web_exports() {
